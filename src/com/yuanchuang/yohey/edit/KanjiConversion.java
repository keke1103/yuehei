...
public class KanjiConversion {
	...
	private static KanjiConversion kanjiConversion = new KanjiConversion();

	public static KanjiConversion getInstance() {
		return kanjiConversion;
	}
